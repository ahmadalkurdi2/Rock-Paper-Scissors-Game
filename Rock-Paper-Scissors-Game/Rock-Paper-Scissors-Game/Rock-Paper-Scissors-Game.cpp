...
{
	short GameRounds{ 0 }, Player1WinTimes{ 0 }, Computer2WinTimes{ 0 }, DrawTimes{ 0 };
	enWinner GameWinner;
	string WinnerName;
};
...
{
	cout << Tabs(3) << "_____________________ [Game Results]_____________________\n\n";
	cout << Tabs(3) << "Game Rounds : " <<
		GameResults.GameRounds << endl;
	cout << Tabs(3) << "Player1 won times : " <<
		GameResults.Player1WinTimes << endl;
	cout << Tabs(3) << "Computer won times : " <<
		GameResults.Computer2WinTimes << endl;
	cout << Tabs(3) << "Draw times : " <<
		GameResults.DrawTimes << endl;
	cout << Tabs(3) << "Final Winner : " <<
